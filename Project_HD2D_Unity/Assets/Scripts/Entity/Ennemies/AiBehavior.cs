...
public class AiBehavior : MonoBehaviour, IDamageableEnemy, ICarryable
{
    #region Variables
    ...
    public AiSearchState SearchState { get; private set; }
    public AiGoToSpawnState GoToSpawnState { get; private set; }
    public AiKOState KoState { get; private set; }
    public AiHitState AiHit { get; private set; }
    public AiDropState DropState { get; private set; }
    public AiFriendlyState FriendlyState { get; private set; }
    public AiExposedState ExposedState { get; private set; }
    ...
    void Awake()
    {
        ...
        ChaseState = new AiChaseState();
        AttackState = new AiAttackState();
        SearchState = new AiSearchState();
        GoToSpawnState = new AiGoToSpawnState();
        KoState = new AiKOState();
        AiHit = new AiHitState();
        DropState = new AiDropState();
        FriendlyState = new AiFriendlyState();
        ExposedState = new AiExposedState();
    ...
    {
        if (currentState is not AiAttackState { CanBeParry: true }) return;
